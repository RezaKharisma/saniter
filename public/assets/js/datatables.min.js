 ...
 *   https://datatables.net/download/#bs4/dt-2.0.2/r-3.0.0
 *
 * Included libraries:
            ...
            for (
                ...
                (i = e.aoColumns[l]),
                    (o = (u = !n || !a[l])
                        ...
                        : a[l]) || Z(e, 0, "Incorrect column count", 18),
    ...
    function ye(e, t) {
        ...
        if (o) {
            if (
                ...
                1 ===
                    (n = (n = B("tr", o)).length ? n : B("<tr/>").appendTo(o))
                        .length
            )
                            ...
                            (function (e, t, n, a) {
                                ...
                                (a || n) && e.oFeatures.bSortMulti
                                    ...
                                    : ((l.length = 0),
                                      l.push([t, s[0]]),
                                      (l[0]._idx = 0));
                            })(i, n[a], a, e.shiftKey) && (t = !0),
                        1 === i.aaSorting.length && "" === i.aaSorting[0][1])
                    )
                        break;
                t &&
                    (w(i, !0),
    ...
    function $e(e) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (t = 0, n = r.length; t < n; t++)
                (a = r[t].src),
                    B(f(e.aoData, "anCells", a)).removeClass(
                        o + (t < 2 ? t + 1 : 3)
                    );
            for (t = 0, n = i.length; t < n; t++)
                (a = i[t].src),
                    B(f(e.aoData, "anCells", a)).addClass(
                        o + (t < 2 ? t + 1 : 3)
                    );
        }
        e.aLastSort = i;
        ...
        if (n.length && e.length) {
            ...
            if (a._details) {
                ...
                var i = n[0],
                    ...
                    l = i.aoData;
                if (
                    (r.off(t + " " + e + " " + a), f(l, "_details").length > 0)
                ) {
                    r.on(t, function (e, t) {
                        if (i !== t) return;
                        r.rows({ page: "current" })
    ...
    function At(e, t, n) {
        ...
        return (
            t <= n
                ...
                : (t - 1 - r <= e
                      ? (a = h(t - (n - 2), t))
                      : ((a = h(e - r + 2, e + r - 1)).push("ellipsis", t - 1),
                        a)
                  ).unshift(0, "ellipsis"),
            a
        );
            ...
            (m.extend(a.prototype, {
                ...
                _childNodesRestore: function (e, t, n) {
                    ...
                    if (this.s.childNodeStore[i]) {
                        ...
                        if (0 < e.length) {
                            for (
                                var s = e[0].parentNode.childNodes,
                                    o = [],
                                    d = 0,
                                    a = s.length;
                                d < a;
                ...
                _resize: function (n) {
                    ...
                    r
                        ...
                        h &&
                            ...
                            m(r.table().node()).trigger(
                                "responsive-resize.dt",
                                [r, this._responsiveOnlyHidden()]
                            ),
                    ...
                    if (
                        ...
                        for (
                            var i = t.table().node().cloneNode(!1),
                                s = m(
                                    t.table().header().cloneNode(!1)
                                ).appendTo(i),
                                o = m(
                                    t.table().footer().cloneNode(!1)
                                ).appendTo(i),
                                d = m(t.table().body())
                                    .clone(!1, !1)
                                    .empty()
                        ...
                        t.rows({ page: "current" }).every(function (n) {
                            ...
                            e &&
                                ...
                                t.cells(n, "*").every(function (e, t) {
                                    ...
                                    (t
                                        ? m(this.node().cloneNode(!1)).append(
                                              m(t).clone()
                                          )
                                        : m(this.node()).clone(!1)
                                    ).appendTo(i);
            ...
            return function (e, d, n, a) {
                if (s.fn.modal) {
                    ...
                    if (d) {
                        if (
                            !s.contains(l, m[0]) ||
                            e.index() !== m.data("dtr-row-idx")
                        )
                            return null;
                        m.find("div.modal-body").empty().append(i);
                    } else
                        r &&
                            r.header &&
                            ((o = (t = m.find("div.modal-header"))
                                .find("button")
                                .detach()),
                            t
                                .empty()
