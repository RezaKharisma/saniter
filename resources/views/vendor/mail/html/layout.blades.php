...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="id" style="padding: 0; margin: 0;">
    <head>
        <meta charset="UTF-8" />
        ...
        <title>Qinarraya Reset Password</title>
        <style type="text/css">
            #outlook a {
                padding: 0;
            }
            ...
            td .es-button-border:hover a.es-button-1713111639134 {
    ...
    <body style="width: 100%; font-family: helvetica, 'helvetica neue', arial, verdana, sans-serif; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; padding: 0; margin: 0;">
        <div dir="ltr" class="es-wrapper-color" lang="id" style="background-color: #fafafa;">
            <table
                class="es-wrapper"
                width="100%"
                cellspacing="0"
                        ...
                        >
                            <tr style="border-collapse: collapse;">
                                <td class="es-adaptive" align="center" style="padding: 0; margin: 0;">
                                    ...
                                    >
                                        <tr style="border-collapse: collapse;">
                                            <td style="margin: 0; padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px; background-color: #cf2e2e;" bgcolor="#cf2e2e" align="left">
                                                                ...
                                                                <tr style="border-collapse: collapse;">
                                                                    <td class="es-m-p0l es-m-txt-c" align="left" style="padding: 0; margin: 0; font-size: 0;">
                                                                        <a
                                                                            ...
                                                                            target="_blank"
                                                                            style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #1376c8; font-size: 14px;"
                                                                        >
                                                                            <img
                                                                                src="{{ asset('assets/img/logo/logo-qinar.png') }}"
                                                                                alt
                                                                ...
                                                                <tr style="border-collapse: collapse;">
                                                                    <td align="center" style="padding: 0; margin: 0; padding-top: 25px; padding-left: 40px; padding-right: 40px;">
                                                                        <p
                                                                            ...
                                                                            "
                                                                        >
                                                                            Jika Anda tidak mengirim permintaan ini, mohon abaikan pesan ini&nbsp;
                                                                        </p>
                                                                        <p
                                                                            style="
                                                                                margin: 0;
                                                                            ...
                                                                            "
                                                                        >
                                                                            Silakan klik tombol di bawah ini untuk mulai proses reset password
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr style="border-collapse: collapse;">
                                                                    <td align="center" style="margin: 0; padding-left: 10px; padding-right: 10px; padding-top: 40px; padding-bottom: 40px;">
                                                                        <a
                                                                            href="https://viewstripo.email/"
                                                                            class="es-button es-button-1713111639134"
                                                                            target="_blank"
                                                                            style="
                                                                                mso-style-priority: 100 !important;
                                                                        ...
                                                                        >
                                                                            <tr style="border-collapse: collapse;">
                                                                                <td valign="top" align="center" style="padding: 0; margin: 0; padding-right: 10px;">
                                                                                    <img
                                                                                        src="https://qoglur.stripocdn.email/content/assets/img/social-icons/rounded-gray/facebook-rounded-gray.png"
                                                                                        alt="Fb"
                                                                                        title="Facebook"
                                                                                        width="32"
                                                                                        style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
                                                                                ...
                                                                                <td valign="top" align="center" style="padding: 0; margin: 0; padding-right: 10px;">
                                                                                    <img
                                                                                        src="https://qoglur.stripocdn.email/content/assets/img/social-icons/rounded-gray/instagram-rounded-gray.png"
                                                                                        alt="Ig"
                                                                                        title="Instagram"
                                                                                        width="32"
                                                                                        style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
                                                                                ...
                                                                                <td valign="top" align="center" style="padding: 0; margin: 0; padding-right: 10px;">
                                                                                    <img
                                                                                        src="https://qoglur.stripocdn.email/content/assets/img/social-icons/rounded-gray/youtube-rounded-gray.png"
                                                                                        alt="Yt"
                                                                                        title="Youtube"
                                                                                        width="32"
                                                                                        style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
                                                                                ...
                                                                                <td valign="top" align="center" style="padding: 0; margin: 0; padding-right: 10px;">
                                                                                    <img
                                                                                        src="https://qoglur.stripocdn.email/content/assets/img/social-icons/rounded-gray/linkedin-rounded-gray.png"
                                                                                        alt="In"
                                                                                        title="Linkedin"
                                                                                        width="32"
                                                                                        style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
                                                                ...
                                                                <tr style="border-collapse: collapse;">
                                                                    <td align="center" style="padding: 0; margin: 0;">
                                                                        <p
                                                                            ...
                                                                            "
                                                                        >
                                                                            Kontak Kami : info@qinarraya.com
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                        ...
                        >
                            <tr style="border-collapse: collapse;">
                                <td style="padding: 0; margin: 0; background-color: #fafafa;" bgcolor="#fafafa" align="center">
                                    ...
                                    >
                                        <tr style="border-collapse: collapse;">
                                            <td style="margin: 0; padding-top: 10px; padding-left: 20px; padding-right: 20px; padding-bottom: 30px; background-color: #cf2e2e;" bgcolor="#cf2e2e" align="left">
                                                <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                    <tr style="border-collapse: collapse;">
                                                        <td valign="top" align="center" style="padding: 0; margin: 0; width: 560px;">
                                                            <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                                                ...
                                                                <tr style="border-collapse: collapse;">
                                                                    <td align="center" style="padding: 0; margin: 0;">
                                                                        <p
                                                                            ...
                                                                            "
                                                                        >
                                                                            Jika Anda mengalami masalah atau memerlukan bantuan lebih lanjut,
                                                                        </p>
                                                                        <p
                                                                            style="
                                                                                margin: 0;
