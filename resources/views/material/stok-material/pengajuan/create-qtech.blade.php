<x-layouts.app title="Tambah Stok Material">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Material / </span>Tambah Stok Material Q-Tech</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="post" action="{{ route('stok-material.pengajuan.store') }}" enctype="multipart/form-data" id="formSubmit">
                    @csrf
                    <input type="hidden" name="typeForm" value="QTECH">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    {{-- Stok Logistik (qty) --}}
                                    <div class="col-12 col-md-5 mb-3 mb-sm-3">
                                        <x-input-text title="Stok Gudang Logistik" name='qty[]' id="qty-{{ $kode }}" readonly />
                                    </div>

                                    {{-- Harga --}}
                                    <div class="col-12 col-sm-8 col-md-5 mb-3 mb-sm-0">
