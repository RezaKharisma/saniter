<x-layouts.app title="Ubah Shift">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengaturan /</span> Ubah Shift</h4>

    <a href="{{ route('shift.index') }}" class="btn btn-secondary mb-3"><i class="bx bx-arrow-back me-1"></i> Kembali</a>

<!-- Striped Rows -->
<div class="card">
    <h5 class="card-header">Form Ubah Shift</h5>
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <select name="regional_id" id="regional_id" class="form-control @error('regional_id') is-invalid @enderror" required>
                    ...
                    @foreach ($regional as $item)
                        <option value="{{ $item->id }}" @if(old('regional_id') == $item->id || $shift->regional_id == $item->id) selected @endif>{{ $item->nama }}</option>
                    @endforeach
                </select>
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-sm-12 col-md-4 mb-3 mb-sm-3 mb-md-0">
                    ...
                    <input type="text" class="form-control @error('jam_masuk') is-invalid @enderror" placeholder="HH:MM" id="jam_masuk" name="jam_masuk" style="background-color: white" value="{{ old('jam_masuk') ?? $shift->jam_masuk }}" required />
                ...
                <div class="col-12 col-sm-12 col-md-4 mb-3 mb-sm-3 mb-md-0">
                    ...
                    <input type="text" class="form-control @error('jam_pulang') is-invalid @enderror" placeholder="HH:MM" id="jam_pulang" name="jam_pulang" style="background-color: white" value="{{ old('jam_keluar') ?? $shift->jam_pulang }}" required/>
            ...
            <div class="mt-3 mb-3">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="is_diff_day" @if($shift->is_diff_day == 1) checked @endif>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <x-input-number title="Menit" name='terlambat_1' placeholder='Menit Keterlambatan' value="{{ old('terlambat_1') ?? $shift->terlambat_1 }}" required/>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="potongan_1" class="form-control @error('potongan_1') is-invalid @enderror" placeholder="Pemotongan Upah" onkeyup="formatRupiah(this)" value="{{ old('potongan_1') ?? $shift->potongan_1 }}" required/>
                                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 mb-3 mb-sm-3 mb-md-0">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <x-input-number title="Menit" name='terlambat_2' placeholder='Menit Keterlambatan' value="{{ old('terlambat_2') ?? $shift->terlambat_2 }}" required/>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="potongan_2" class="form-control @error('potongan_2') is-invalid @enderror" placeholder="Pemotongan Upah" onkeyup="formatRupiah(this)" value="{{ old('potongan_2') ?? $shift->potongan_2 }}" required/>
                                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-4 mb-3 mb-sm-3 mb-md-0">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <x-input-number title="Menit" name='terlambat_3' placeholder='Menit Keterlambatan' value="{{ old('terlambat_3') ?? $shift->terlambat_3 }}" required/>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="potongan_3" class="form-control @error('potongan_3') is-invalid @enderror" placeholder="Pemotongan Upah" onkeyup="formatRupiah(this)" value="{{ old('potongan_3') ?? $shift->potongan_3 }}" required/>
                                    </div>
