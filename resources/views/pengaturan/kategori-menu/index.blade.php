            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-2">
                        <button type="button" class="btn btn-secondary me-0" data-bs-toggle="modal" data-bs-target="#modalKategoriMenu"><i class="bx bx-plus"></i>Tambah Kategori Menu</button>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('pengaturan.kategorimenu.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- Input Judul --}}
                        <x-input-text title="Kategori Menu" name="nama_kategori" placeholder="Masukkan kategori menu" margin="mb-3" />
            ...
            <div class="modal-content">
                ...
                <form id="formEdit" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- Input Judul --}}
                        <x-input-text title="Kategori" name="nama_kategori" id="nama_kategoriEdit" placeholder="Masukkan kategori menu" margin="mb-3" />
