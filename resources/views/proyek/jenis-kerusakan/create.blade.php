                        ...
                        <div id="pekerjaList">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-5 mb-3">
                                    ...
                                    <select name="nama_pekerja[]" id="nama_pekerja" class="form-control w-100 @error('nama_pekerja') is-invalid @enderror" onchange="fillSatuan('nama_pekerja','satuan_pekerja')">
                                        <option value="" data-kode_material="0" data-harga="0" selected disabled>Pilih nama pekerja...</option>
                                        @foreach ($pekerja as $item)
                                            <option value="{{ $item->id }}" data-upah="{{ $item->upah }}" data-satuan="{{ $item->satuan }}">{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-sm-12 col-md-5 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '')"  class="form-control @error('volume_pekerja') is-invalid @enderror" id="volume_pekerja" name="volume_pekerja[]" placeholder="Volume"/>
                                        <span class="input-group-text" id="satuan_pekerjaHTML">satuan*</span>
                                    </div>
                        ...
                        <div id="itemPekerjaanList">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-5 mb-3">
                                    ...
                                    <select name="item_pekerjaan[]" id="item_pekerjaan" class="form-control w-100 @error('item_pekerjaan') is-invalid @enderror" onchange="fillSatuan('item_pekerjaan','satuan_item_pekerjaan')">
                                ...
                                <div class="col-12 col-sm-12 col-md-5 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '')"  class="form-control @error('volume_item_pekerjaan') is-invalid @enderror" id="volume_item_pekerjaan" name="volume_item_pekerjaan[]" placeholder="Volume"/>
                                        <span class="input-group-text" id="satuan_item_pekerjaanHTML">satuan*</span>
                                    </div>
                        ...
                        <div id="perbaikanList" class="">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-5 mb-3">
                                    ...
                                    <select name="nama_material[]" id="nama_material" class="form-control w-100 @error('nama_material') is-invalid @enderror" required onchange="fillSatuan('nama_material','satuan')">
                                ...
                                <div class="col-12 col-sm-12 col-md-5 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text" id="satuanHTML">satuan*</span>
                                    </div>
