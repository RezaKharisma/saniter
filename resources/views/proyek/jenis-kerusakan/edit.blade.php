    ...
    <div class="row">
        ...
        <div class="col-12 order-2 order-md-1 mb-3">
            <div class="card">
                    ...
                    <div id="peralatanList">
                        ...
                        @empty
                            ...
                            <div class="row" id="list-peralatan-{{ $kode }}">
                                <div class="col-12">
                                    <div class="divider text-start">
                                        <div class="divider-text" id="nomorPeralatan-{{ $kode }}">Peralatan 1</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-5 mb-3">
                                    <x-partials.label title="Nama Peralatan" />
                                    <select name="nama_peralatan[]" id="peralatan-{{ $kode }}" class="form-control w-100 @error('nama_peralatan') is-invalid @enderror" onchange="fillSatuan('peralatan-{{ $kode }}','satuan_peralatan-{{ $kode }}')">
                                        <option value="" data-id="0" data-harga="0" selected disabled>Pilih nama material...</option>
                                        @foreach ($stokMaterial as $item)
                                            <option value="{{ $item->id }}" data-id="{{ $item->id }}" data-harga="{{ $item->harga }}">{{ $item->nama_peralatan }}</option>
                                        @endforeach
                                    </select>
                                    <x-partials.error-message name="nama_peralatan[]" class="d-block"/>
                                </div>
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-primary" id="btnAddMaterial" onclick="addListPeralatan(this)"><i class="bx bx-plus"></i> Tambah Peralatan</button>
                </div>
            </div>
        </div>
