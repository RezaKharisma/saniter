...
<div class="card mb-12">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h5 class="mb-0">Form Update User</h5>
      ...
      <form method="post" action="{{ route('user.update', $user->id) }}">
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" name="name" class="form-control" id="basic-icon-default-fullname" value="{{ $user->name }}">
          </div>
        </div>
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" name="email" id="basic-icon-default-company" class="form-control" value="{{ $user->email }}">
          </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="text" name="nik" id="basic-icon-default-company" class="form-control" value="{{ $user->nik }}" >
            </div>
          </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" name="telp" id="basic-icon-default-phone" class="form-control phone-mask" value="{{ $user->telp }}">
          </div>
        </div>
