<x-layouts.app title="Tambah User">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Administrasi /</span> Tambah User</h4>
                ...
                <div class="row mb-3">
                    <div class="col-12 col-sm-12 col-md-6 mb-3 mb-sm-3 mb-md-0">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <textarea name="alamat_ktp" class="form-control  @error('alamat_ktp') is-invalid @enderror" rows="3">{{ old('alamat_ktp') }}</textarea>
                        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 mb-3 mb-sm-3 mb-md-0">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <textarea name="alamat_dom" class="form-control @error('alamat_dom') is-invalid @enderror" rows="3">{{ old('alamat_dom') }}</textarea>
                        </div>
